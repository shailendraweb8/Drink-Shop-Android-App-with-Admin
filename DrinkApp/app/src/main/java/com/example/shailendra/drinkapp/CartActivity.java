...
import com.example.shailendra.drinkapp.Adapter.CartAdapter;
...
public class CartActivity extends AppCompatActivity implements RecyclerItemTouchHelperListener {
    ...
    IDrinkShopAPI mServiceScalars;    // for payment
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mServiceScalars = Common.getScalarsAPI();   //for payment
    ...
    private void placeOrder() {
        ...
        builder.setNegativeButton("CANCEL", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
               ...
               orderComment = edt_comment.getText().toString();  //somechanges when adding payment gateway
                ...
                //when adding payment gateway SUBMIT ORDER code cut from here & paste INTO sendPayment()
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PAYMENT_REQUEST_CODE)
        {
            ...
            else
            {
                ...
                Log.e("SM_ERROR" , error.getMessage());
            }
        }
    }
        ...
        mServiceScalars.payment(params.get("nonce") , params.get("amount"))
                .enqueue(new Callback<String>() {
                    ...
                    public void onResponse(Call<String> call, Response<String> response) {
                                            ...
                                            .subscribe(new Consumer<List<Cart>>() {
                                                ...
                                                public void accept(List<Cart> carts) throws Exception {
                                                    if (!TextUtils.isEmpty(orderAddress))
                                                        ...
                                                        Toast.makeText(CartActivity.this, "Order Address can't Empty", Toast.LENGTH_SHORT).show();
                                                }
                                            })
                            );
                        ...
                        Log.d("SM_INFO",response.body());
                    }

                    @Override
                    public void onFailure(Call<String> call, Throwable t) {

                        Log.d("SM_INFO",t.getMessage());
                    }
                });
